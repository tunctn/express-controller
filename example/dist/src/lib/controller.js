...
var auth = authMiddleware(function() {
...
var auth2 = authMiddleware(function() {
    var _ref = _async_to_generator(function(param) {
        var req, res, test;
        return _ts_generator(this, function(_state) {
            req = param.req, res = param.res;
...
export var createController = function() {
    return new Controller().extend(auth).extend(auth2);
};
createController().withAuth().build(function() {
    var _ref = _async_to_generator(function(param) {
        var req, res;
        return _ts_generator(this, function(_state) {
            req = param.req, res = param.res;
